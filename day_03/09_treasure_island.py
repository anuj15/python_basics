# Program to play treasure island game
print('''
*******************************************************************************
          |                   |                  |                     |
...
if direction == 'left':
    across = input('You came across a lake. There is an island in the middle of the lake. Type "wait" to wait for a '
    ...
    print('You fall into a ditch. Game Over.')
